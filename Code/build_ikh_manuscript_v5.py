...
OUTPUT = "Manuscript_ICSH_2026_v5.docx"
...
add_p("Sensitivity Analysis: Because only three studies contributed to the quantitative synthesis, a Hartung-Knapp-Sidik-Jonkman (HKSJ) sensitivity analysis was performed to assess the robustness of the confidence interval. The HKSJ method yielded the same point estimate with a wider confidence interval (OR = 0.164; 95% CI: 0.064 to 0.419; p = 0.042). The wider interval reflects the small number of studies, and the pooled effect remained statistically significant under both models.",
      align=WD_ALIGN_PARAGRAPH.JUSTIFY, space_after=6)
...
# ETHICAL STATEMENT
# ============================================================
add_p("Ethical Statement", bold=True, size=12, space_before=6, space_after=6)
add_p("Ethical approval was not required as this study is a secondary systematic review and meta-analysis of publicly available, published trial data. The authors declare no conflicts of interest.",
      align=WD_ALIGN_PARAGRAPH.JUSTIFY, space_after=12)
